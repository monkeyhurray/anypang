...
export class SettingsPopup extends Container {
    ...
    constructor() {
        ...
        this.versionLabel = new Label(
            `${i18n.settingsVersion} ${APP_VERSION}`,
            {
                fill: 0xffffff,
                fontSize: 12,
            }
        ...
        this.mode.onChange.connect(() => {
            getUserSettings().setGameMode(this.mode.getSelectedMode());
        });
    ...
    public prepare() {
        ...
        this.masterSlider.value = getUserSettings().getMasterVolume() * 100;
        this.bgmSlider.value = getUserSettings().getBgmVolume() * 100;
        this.sfxSlider.value = getUserSettings().getSfxVolume() * 100;
        this.mode.setSelectedMode(getUserSettings().getGameMode());
    }
